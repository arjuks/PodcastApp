...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.ViewHolder> {
    ...
    GridAdapter(List<Podcast> pod, Context context) {
        this.podlist = pod;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Picasso.with(callingContext).load(podlist.get(i).getImg_url()).into(viewHolder.imgThumbnail);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imgThumbnail = (ImageView)itemView.findViewById(R.id.cardViewImage);
